...
?><html>
    <head>
        ...
        <style>
            ...
            .<?php echo $id ?> .view-source-button{
                text-align: center;
                padding-top: 1rem;
            }
            .<?php echo $id ?> .view-source-button > a{
            ...
            .<?php echo $id ?> .view-source-button > a:hover{
                color: #555;
            }
            .<?php echo $id ?> .view-source-button > a:active{
                color: #222;
            }
            .<?php echo $id ?> a{
                color: #000;
    ...
    <body>
        <div class="<?php echo $id ?>">
            ...
            <component src="file:components/lazy-image.php" style="margin-bottom:1rem;" aspectRatio="<?php echo 1500 / 1000 ?>" original="images/1500.jpg" versions="images/500.jpg 500w, images/700.jpg 700w, images/1000.jpg 1000w, images/1500.jpg 1500w"/>
            ...
            <component src="file:components/carousel.php" margin="10">
            ...
            <component src="file:components/disqus-comments.php" shortName="ivopetkovgithubio"/>
            ...
            <div style="text-align:center;">
                <component src="file:components/social-buttons.php" url="http://ivopetkov.com/b/html-server-components/"/>
            </div>
        </div>
    </body>
</html>